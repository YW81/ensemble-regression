...
close all;
clear all;
%load DifferentRegressors_Friedman1
%load DifferentRegressors_Friedman2
%load DifferentRegressors_Friedman3
y_true = y; clear y;
...
labels = {'Oracle', 'Oracle Rho', 'Mean', 'Best', 'Uns. D-GEM','Uns. GEM','Uns. PCR*', 'Low Rank Misfit', 'Low Rank Misfit CVX'};
idxs = [1 2 3 7 4 5 6 8 9 ]; idxs = idxs(end:-1:1);
colors = num2cell(jet(num_predictors),2);
